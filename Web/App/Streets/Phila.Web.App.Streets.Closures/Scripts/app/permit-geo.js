...
//    self.AddessLine = addressLine;
//    self.FrormatedAddress = formattedAddress;
//}
...
//                        locs.push(new LocationWaypoint(++order, wpLat[i], wpLong[i], data.resourceSets[0].resources[0].address.addressLine, data.resourceSets[0].resources[0].address.formattedAddress));
//                        //console.log(locs);
//                    }
